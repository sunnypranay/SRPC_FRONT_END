...
function Register() {
  ...
  useEffect(() => {
    if (last_name){
      setPassword(last_name.toLowerCase().replace(/\s/g, '') + "2023");
      // console.log(last_name.toLowerCase().replace(/\s/g, '') + "2023");
    }
  }, [last_name]);
    ...
    <Form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div id = "note" style={{color : "red"}}>
        ...
        <ul>
          ...
          <li>Your password will be your last name, followed by 2023. If your last name is Smith, your password will be Smith2023.</li> <br/>
      ...
      <label htmlFor="password" className="block text-xl font-semibold">
        ...
        <Form.Control 
          type="text" 
          placeholder="Your password will be your Last Name followed by 2023" 
          value={last_name.toLowerCase().replace(/\s/g, '') + "2023"} onChange={(e) => setPassword(e.target.value)} disabled/> 
        ) : (
        <Form.Control
          type="text"
          placeholder="Your password will be your Last Name followed by 2023"
